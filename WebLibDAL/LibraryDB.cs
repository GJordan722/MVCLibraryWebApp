    ...
    public class LibraryDB
    {
        ...
        public DataTable retrieveUser(string UserName, string Password)
        {
            ...
            using (SqlConnection con = new SqlConnection(connection))
            {
                ...
                try
                {
                    using (SqlCommand cmd = new SqlCommand($"EXEC [dbo].[retrieveUserInfo] {UserName},{Password}", con))
                    {
        ...
        public int? UpdateMedia(Media media,int? media_id, string? media_name, string? media_type, string? author, string? publisher)
        {
            ...
            string where = $"WHERE media_id = {media.Media_ID} AND media_name = {media.Media_Name} AND media_type = {media.Media_Type} AND author = {media.Author} AND Publisher = {media.Publisher}";
